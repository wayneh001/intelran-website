<template>
  <div>
        ...
        <div class="mb-3">
          <div class="d-flex justify-content-center align-items-center mb-3">
            <div style="height: 200px; line-height: 200px">
              <img class="mx-auto" style="width: 200px" :src="e.src" />
            </div>
          </div>
            ...
            >
              <div class="row d-flex justify-content-center">
                <div
                  ...
                  :key="n"
                  class="color-block color-block-click ms-0 me-4"
                  :class="[
                    n,
                    {
          ...
          <div v-if="e.name === 'Universal Switch'" class="mb-3">
            <label
              id="switchConfig"
              :class="[
          ...
          <div v-if="e.name === 'Blinds Driver'" class="mb-3">
            <label
              id="blindsConfig"
              :class="[
                { 'config-setter-header-light': this.mode === 'Light' },
    ...
    <div class="col-12 col-md-6 w-100 mb-3">
      <label
        id="total"
        :class="[
          { 'form-label-light': this.mode === 'Light' },
